...
object Endpoints {
    ...
    const val URL_MULTI = "/api/multi/user/{username}/m/{multiname}/.json"
    const val URL_MULTI_SUB = "/api/multi/user/{username}/m/{multiname}/r/{subname}/.json"
    const val URL_MULTI_SUBS = "/user/{username}/m/{multiname}/{sorting}/.json"
